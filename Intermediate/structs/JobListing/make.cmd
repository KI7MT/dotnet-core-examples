::-----------------------------------------------------------------------------::
:: Name .........: make.cmd
:: Project ......: dotnet-core-examples : JobListing
:: Description ..: Make file to manage JobListing Globally
...
CLS
ECHO ------------------------------
ECHO  Clean JobListing v%app_ver%
ECHO ------------------------------
ECHO.
dotnet clean
GOTO EOF
...
:: Install JobListing to the --global dotnet applicaiton directory
:_INSTALL
CLS
ECHO ------------------------------
...
:: Uninstall JobListing from the --global dotnet applicaiton directory
:_UNINSTALL
CLS
ECHO --------------------------------------------
