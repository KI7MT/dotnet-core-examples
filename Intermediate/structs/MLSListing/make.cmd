::-----------------------------------------------------------------------------::
:: Name .........: make.cmd
:: Project ......: dotnet-core-examples : MLSListing
:: Description ..: Make file to manage MLSListing Globally
...
CLS
ECHO ------------------------------
ECHO  Clean MLSListing v%app_ver%
ECHO ------------------------------
ECHO.
dotnet clean
GOTO EOF
...
:: Install MLSListing to the --global dotnet applicaiton directory
:_INSTALL
CLS
ECHO ------------------------------
...
:: Uninstall MLSListing from the --global dotnet applicaiton directory
:_UNINSTALL
CLS
ECHO --------------------------------------------
